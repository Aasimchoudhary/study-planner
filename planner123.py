...
try:
    ...
    st.error(
        "Could not load your StudyPlanner data."
    )
...
with st.form("change_password_form"):
        ...
        if not current_password:
            ...
            try:
                ...
                if verification.user is None:
                    ...
                    st.info(
                        "You can now use your new password the next time you log in."
                    )
    ...
    st.warning(
        "Account deletion is not included in V3.0 yet. "
        "We'll add it later with proper confirmation and security."
    )
